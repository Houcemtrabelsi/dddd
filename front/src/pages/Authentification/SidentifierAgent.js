  ...
  return (
    <Card>
      ...
      >
        ...
        <PA> _______ Ou connectez-vous en utilisant _______ </PA>
        <Foote>
          <IM src={google} />
          <IM src={faceb} />
          <IM src={apple} />
      ...
      <Blue>
        ...
        <Para>
          Inscrivez-vous en quelques étapes faciles et nous vous contacterons
...
export default SindentifierAgent;
